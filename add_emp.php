...
<body>
	...
	<form  method='POST' action="add_emp.php">	
		...
		<input type="number" min="1900" max="2018" name="year" id= "year" placeholder="yyyy" value="<?php echo $yy; ?>" required>
		...
		<input type="number" min="1900" max="2018" name="year_join" id= "yearj" placeholder="yyyy" value="<?php echo $yj; ?>" required>
